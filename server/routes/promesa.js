var file_name = require('../data/promesa').file_name
...
router.get('/', helpers.isFirmado, helpers.hasPermiso([1]), getAll)
router.get('/vista/:view', helpers.isFirmado, helpers.hasPermiso([1]), getView)
router.get('/buscar/:query', helpers.isFirmado, helpers.hasPermiso([1]), getFind)
router.get('/reporte', helpers.isFirmado, helpers.hasPermiso([1]), getReport)
router.get('/reporte/buscar/:query', helpers.isFirmado, helpers.hasPermiso([1]), getReportFind)
router.get('/reporte/:file', helpers.isFirmado, helpers.hasPermiso([1]), getReportFile)

router.get('/:id', helpers.isFirmado, helpers.hasPermiso([1]), get)

router.post('/', helpers.isFirmado, helpers.hasPermiso([1]), setNew)
router.post('/lista', helpers.isFirmado, helpers.hasPermiso([1]), upload.single('archivo'), setNewList)
router.post('/buscar', helpers.isFirmado, helpers.hasPermiso([1]), upload.single('archivo'), getAll)
router.post('/vista', helpers.isFirmado, helpers.hasPermiso([1]), getView)
router.post('/reporte', helpers.isFirmado, helpers.hasPermiso([1]), getReport)

router.put('/', helpers.isFirmado, helpers.hasPermiso([1]), setUpdate)
